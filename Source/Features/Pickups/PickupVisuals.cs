...
public static class PickupVisuals
{
    public static Color GetColor(PickupType type) => type switch
    {
        ...
        PickupType.TreasureCross => new Color(220, 220, 220, 200),
        PickupType.TreasureChalice => new Color(200, 180, 255, 200),
        PickupType.TreasureChest => new Color(180, 120, 60, 200),
        PickupType.TreasureCrown => new Color(255, 210, 50, 220),
    ...
    public static string GetLabel(PickupType type) => type switch
    {
        ...
        PickupType.TreasureCross => "X",
        PickupType.TreasureChalice => "C",
        PickupType.TreasureChest => "T",
        PickupType.TreasureCrown => "CR",
        _ => "?"
    };
}
